...
document.addEventListener("DOMContentLoaded", function () {
	  dynamicCart('<%=request.getContextPath()%>/CarrelloServlet?isbn=<%=request.getParameter("isbn")%>', "2");
	});
</script>
<main>
...
<script>
	document.addEventListener("DOMContentLoaded", function () {
	  document.getElementById("dinamico").addEventListener("keydown", function (e) {
