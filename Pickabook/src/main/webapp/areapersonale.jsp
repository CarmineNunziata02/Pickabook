...
<script>
  ...
  <%if (user instanceof  User) {%>
    $(document).ready(function() {
      ...
      contenutoHtml += '<li> <a href="ordine.jsp"><img class="proimg" alt="" src="./icons/calendar.ico">I miei Ordini</a></li>';
  ...
  <%}else if(flag != null && flag){%>
    $(document).ready(function() {
      ...
      contenutoHtml += '<li> <a href="eliminaProdotto.jsp"> <img class=\"adimg\" src="./icons/trash.ico"> Elimina Prodotto <p> (ADMIN) </p></a> </li>';
